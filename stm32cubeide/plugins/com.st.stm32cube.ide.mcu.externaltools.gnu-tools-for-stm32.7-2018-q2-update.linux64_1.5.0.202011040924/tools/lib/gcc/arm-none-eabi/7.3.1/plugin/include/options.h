...
enum opt_code
{
  ...
  OPT_fcyclomatic_complexity = 562,          /* -fcyclomatic-complexity */
  ...
  OPT_mcallee_super_interworking = 1161,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1162,     /* -mcaller-super-interworking */
  OPT_mcmse = 1163,                          /* -mcmse */
  OPT_mcpu_ = 1164,                          /* -mcpu= */
  OPT_mfix_cortex_m3_ldrd = 1165,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 1166,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1167,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1168,                  /* -mfp16-format= */
  OPT_mfpu_ = 1169,                          /* -mfpu= */
  /* OPT_mhard_float = 1170, */              /* -mhard-float */
  OPT_mlittle_endian = 1171,                 /* -mlittle-endian */
  OPT_mlong_calls = 1172,                    /* -mlong-calls */
  OPT_mneon_for_64bits = 1173,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1174,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1175,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1176,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1177,               /* -mprint-tune-info */
  OPT_mpure_code = 1178,                     /* -mpure-code */
  OPT_mrestrict_it = 1179,                   /* -mrestrict-it */
  OPT_msched_prolog = 1180,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1181,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1182,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1183, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1184,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1185,                         /* -mthumb */
  OPT_mthumb_interwork = 1186,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1187,                  /* -mtls-dialect= */
  OPT_mtp_ = 1188,                           /* -mtp= */
  OPT_mtpcs_frame = 1189,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1190,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1191,                         /* -mtune= */
  OPT_munaligned_access = 1192,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1193,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1194,      /* -mvectorize-with-neon-quad */
  OPT_mword_relocations = 1195,              /* -mword-relocations */
  OPT_n = 1196,                              /* -n */
  ...
  OPT_s = 1228,                              /* -s */
  OPT_save_temps = 1229,                     /* -save-temps */
  OPT_save_temps_ = 1230,                    /* -save-temps= */
  OPT_shared = 1231,                         /* -shared */
  OPT_shared_libgcc = 1232,                  /* -shared-libgcc */
  /* OPT_specs = 1233, */                    /* -specs */
  OPT_specs_ = 1234,                         /* -specs= */
  OPT_static = 1235,                         /* -static */
  OPT_static_libasan = 1236,                 /* -static-libasan */
  OPT_static_libgcc = 1237,                  /* -static-libgcc */
